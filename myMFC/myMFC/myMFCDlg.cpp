...
BEGIN_MESSAGE_MAP(CmyMFCDlg, CDialogEx)
	...
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_BN_CLICKED(IDC_VC, &CmyMFCDlg::OnBnClickedVc)
	ON_BN_CLICKED(IDC_Python, &CmyMFCDlg::OnBnClickedPython)
END_MESSAGE_MAP()
...
void CmyMFCDlg::OnBnClickedPython()
{
	// TODO: 在此添加控件通知处理程序代码
	WinExec("py_snowCode.exe",SW_SHOW);
}
